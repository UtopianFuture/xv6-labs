...
void            proc_freekpagetablenophy(pagetable_t);
void            proc_freekstack(struct proc *);
int             kill(int);
...
void            kuvmfree(pagetable_t, uint64, uint64);
...
void            copypage(pagetable_t, pagetable_t, uint64, uint64);
void            vmprint(pagetable_t);
void            tbprint(pagetable_t, int);
